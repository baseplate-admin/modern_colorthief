...
var gpu = webgpu.create(['backend=vulkan']);
...
// so Reflect::get on the cached object can't see navigator.gpu. A property defined via
// Object.defineProperty is on the real globalThis and survives the cache.
Object.defineProperty(globalThis, '__wt_get_gpu', {
    value: function() { return globalThis.navigator && globalThis.navigator.gpu; },
    configurable: true,
    writable: true,
});
