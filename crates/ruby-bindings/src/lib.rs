use magnus::{define_module, error, exception, function, Object, RString};
...
fn init_colorthief_ruby() {
    ...
    mod_colorthief.define_singleton_method("get_palette", function!(get_palette, 5)).unwrap();
    mod_colorthief.define_singleton_method("get_color", function!(get_color, 4)).unwrap();
}
